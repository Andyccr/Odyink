...
rem 检查更新
    :update
    cd ..\
    wget %WO% https://odyink.top/Update.bat 2>nul
    if not exist Bloglist.bat %pswget% https://odyink.top/Update.bat %PSO% Update.bat >nul
    set updateYN=
    call Update.bat
    rem 当前版本(整数)
    set version=4
